package com.example.easytour.createluggage.CalendarUtil.customview;
...
import com.example.easytour.createluggage.CalendarUtil.adapter.CalendarGridViewAdapter;
            ...
            if (dateItem.getDateOfMonth()!=0&&(i%7!=6&&i%7!=0)) {
                if (isselect) {
                    if (!dateItem.isselect()) {
                        ...
                        textView.setBackgroundColor(getResources().getColor(R.color.cpb_blue));
                    ...
                    if (dateItem.isselect()) {
                        ...
                        calendar.set(currentYear, currentMonth, dateItem.getDateOfMonth());
                        TextView textView = (TextView) gridView.getChildAt(i);
                        textView.setBackgroundColor(getResources().getColor(R.color.cpb_green));
